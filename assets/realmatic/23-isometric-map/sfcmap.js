...
function( key, vals) {
  ...
  new bootstrap.Popover($("#"+key+"_Site").parent(), { trigger:'hover', placement:'top', title : $("#"+key+"_Site").attr('data-name').replace(' Site', ''), html:true, content: '<i>'+ vals[1] +'</i><img src="/assets/realmatic/media/duckfiller.png" class="img-fluid">', container: 'body', customClass:'hbg'+key })
/*
